...
class AppController extends Controller {
	...
	//Define quais actions em todos os controllers estao liberadas
	//para um usuario sem login pode acessar
	//Para este caso nada estara liberado porque isso sera feito internamente
	//em todas os controllers se necessaria a liberacao de uma action especifica
	//Define tambem se existe usuario logado e captura os dados desse usuario
	public function beforeFilter(){

		//$this->Auth->allow('NOME DA ACTION'); PODE LIBERAR ACTIONS NO CONTEXTO GERAL AQUI
