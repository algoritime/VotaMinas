<nav class="submenu">
    <ul id="typesPools" class="menu">
        <li class="active"><a href="votationPresident">Presidente</a></li>
        ...
        <li><a href="votationRepresentative">Deputado Estadual</a></li>
    </ul>
</nav>
<div class="candidates">
    <fieldset>
            <legend>Candidatos a presidente</legend>
        <?php  if($pool_id != -99): ?>
                ...
                <fieldset>
                    <?php
                        ...
                        <?php
                            ...
                            echo $this->Html->link('aqui', array('controller' => 'candidates', 'action' => 'presidents'));
                            echo '!';
                            echo '</div>';
                        endif;
                    ?>
