<nav class="submenu">
    <ul id="typesPools" class="menu">
        ...
        <li class="active"><a href="votationGovernor">Governador</a></li>
...
<div class="candidates">
    <fieldset>
            <legend>Candidatos ao governo</legend>
        <?php  if($pool_id != -99): ?>
                ...
                <fieldset>
                    <?php
                        ...
                        <?php
                            ...
                            echo $this->Html->link('aqui', array('controller' => 'candidates', 'action' => 'governors'));
                            echo '!';
                            echo '</div>';
                        endif;
                    ?>
